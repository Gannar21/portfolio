...
const HIGHLIGHTS = [
  {
    icon: Code2,
    label: 'Projects',
    description: 'Web applications, SaaS platforms, and AI tooling',
  },
  {
    icon: GitBranch,
    label: 'Open Source',
    description: 'Experimenting with and contributing to the ecosystem',
  },
  {
    icon: Star,
    label: 'Learning',
    description: 'Exploring new frameworks, tools, and architectures',
  },
];
        ...
        <div className="max-w-3xl mx-auto text-center">
          ...
          <motion.div {...animate(0.2)} className="grid sm:grid-cols-3 gap-4 mb-8">
            {HIGHLIGHTS.map(({ icon: Icon, label, description }) => (
              <div key={label} className="card text-left">
                <div className="w-9 h-9 rounded-lg bg-charcoal flex items-center justify-center mb-3">
          ...
          <motion.div {...animate(0.27)}>
            <a
              ...
              className="inline-flex items-center gap-2.5 px-6 py-3 rounded-xl bg-charcoal text-white font-semibold text-sm transition-all duration-200 hover:bg-charcoal-light hover:shadow-card-hover focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-charcoal active:scale-[0.98]"
